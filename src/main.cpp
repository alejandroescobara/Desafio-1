...
//
//NO UTILIZAR 110, eliminar solo de manera iterativa
//
//mascara AND llena de 111 que solo es 0 en los bits que quieres borrar, despues se aplica una mascara xor 
...
int main() {
  while (true) {
    ...
    /*
    unsigned char* test_board = new (std::nothrow) unsigned char[10];

    test_board[0] = 0b10000110;
    test_board[1] = 0b00110101;
    test_board[2] = 0b01000000;
    test_board[3] = 0b00000000;
    test_board[4] = 0b00000000;
    test_board[5] = 0b00000000;
    test_board[6] = 0b00000000;
    test_board[7] = 0b00000000;
    test_board[8] = 0b00000000;
    test_board[9] = 0b00011111;
    */
    ...
    while (true) {
      ...
      //print_board(5,10,25,test_board);
      do {
        std::cout << "\n\n "; 
